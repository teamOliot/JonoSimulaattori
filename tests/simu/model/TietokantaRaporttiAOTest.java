...
class TietokantaRaporttiAOTest {
	...
	void testReadRaportit() {
		...
		tietokantaraporttiDAO.createRaportti(raportti);
		raportit = tietokantaraporttiDAO.readRaportit();
		assertEquals(1, raportit.length, "Tietokanna lukeminen palauttaa väärää tietoa.");
	}
}
